...
test_that("correct plot_hexbin majority", {
  ...
  expect_equal(
    class(schex:::.plot_hexbin(drhex, colour_by = "lab_majority",
                               action="majority"))[2],
    "ggplot"
  )
})
...
test_that("correct plot_hexbin prop", {
  ...
  expect_equal(
    class(schex:::.plot_hexbin(drhex, colour_by = "lab_prop_2",
                       action="prop"))[2],
    "ggplot"
  )
})
...
test_that("correct plot_hexbin numeric", {
  ...
  expect_equal(
    class(schex:::.plot_hexbin(drhex, colour_by = "lab_mean",
        action="mean"))[2],
    "ggplot"
  )
})
...
test_that("correct plot_hexbin_meta class prop SingleCellExperiment", {
    ...
    expect_equal(class(plot_hexbin_meta(pbmc_small, col="random",
        action="prop", no=1))[2], "ggplot")
})
