...
```{r calc-hexbin}
pbmc.sce <- make_hexbin(pbmc.sce, nbins = 10, 
...
gene_id <-"CD1C"
schex::plot_hexbin_feature(pbmc.sce, type="counts", feature=gene_id, 
...
```{r}
gene_id <-"CD1C"
gg <- schex::plot_hexbin_feature(pbmc.sce, type="counts", feature=gene_id, 
    action="mean", xlab="UMAP1", ylab="UMAP2", 
    title=paste0("Mean of ", gene_id))
gg + theme_void()
```
